...
ANSC_STATUS CosaDmlLgiMTAInit (ANSC_HANDLE hDml, PANSC_HANDLE phContext)
{
...
ANSC_STATUS CosaDmlMTAGetPacketCableRegion (ANSC_HANDLE hContext, ULONG *pPacketCableRegion)
{
...
ULONG CosaDmlMTALineInfoGetNumberOfEntries (ANSC_HANDLE hContext)
{
    return mta_hal_LineInfoGetNumberOfEntries();
}

ANSC_STATUS CosaDmlMTALineInfoGetEntry (ANSC_HANDLE hContext, ULONG ulIndex, PCOSA_LGI_MTA_LINEINFO pEntry)
{
...
ANSC_STATUS CosaDmlMTALineInfoSetAdminStatus (ANSC_HANDLE hContext, ULONG ulIndex, ULONG ulValue)
{
